...
namespace IIS.Serezhatatarincev2
{
    ...
    public class РабочееМесто : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Serezhatatarincev2.Филиал fФилиал;
        
        private IIS.Serezhatatarincev2.DetailArrayOfОборудование fОборудование;
        
        private IIS.Serezhatatarincev2.DetailArrayOfПО fПО;
        ...
        [PropertyStorage(new string[] {
                "Филиал"})]
        [NotNull()]
        public virtual IIS.Serezhatatarincev2.Филиал Филиал
        {
            get
            {
                ...
                IIS.Serezhatatarincev2.Филиал result = this.fФилиал;
        ...
        public virtual IIS.Serezhatatarincev2.DetailArrayOfОборудование Оборудование
        {
            get
            {
                ...
                {
                    this.fОборудование = new IIS.Serezhatatarincev2.DetailArrayOfОборудование(this);
                }
                IIS.Serezhatatarincev2.DetailArrayOfОборудование result = this.fОборудование;
        ...
        public virtual IIS.Serezhatatarincev2.DetailArrayOfПО ПО
        {
            get
            {
                ...
                if ((this.fПО == null))
                {
                    this.fПО = new IIS.Serezhatatarincev2.DetailArrayOfПО(this);
                }
                IIS.Serezhatatarincev2.DetailArrayOfПО result = this.fПО;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РабочееМестоE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РабочееМестоE", typeof(IIS.Serezhatatarincev2.РабочееМесто));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РабочееМестоL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РабочееМестоL", typeof(IIS.Serezhatatarincev2.РабочееМесто));
                }
            }
        }
    }
