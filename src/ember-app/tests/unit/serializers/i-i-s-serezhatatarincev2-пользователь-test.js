...
moduleForModel('i-i-s-serezhatatarincev2-пользователь', 'Unit | Serializer | i-i-s-serezhatatarincev2-пользователь', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-serezhatatarincev2-пользователь',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
