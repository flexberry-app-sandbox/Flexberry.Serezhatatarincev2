...
moduleForModel('i-i-s-serezhatatarincev2-рабочее-место', 'Unit | Serializer | i-i-s-serezhatatarincev2-рабочее-место', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-serezhatatarincev2-рабочее-место',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
