...
moduleForModel('i-i-s-serezhatatarincev2-оборудование', 'Unit | Serializer | i-i-s-serezhatatarincev2-оборудование', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-serezhatatarincev2-оборудование',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
